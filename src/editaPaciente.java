...
public class editaPaciente extends JFrame {
...
public void posiciona(){
	...
	public editaPaciente(String titulo,int id)  {
		super(titulo);
		//janela
	...
	//====================================================================
		...
		cb_estCivil = new JComboBox(civil);
		cnt.add(cb_estCivil);
	...
	// bordas =================================================
		...
		cadastro_Paciente = new JLabel("EDITAR PACIENTES");
	...
	public void carrega(int id){
		...
		for (Paciente c : dao.getContatoById(id)) {
			txb_nmPaciente.setText(c.getNome());
			txb_endereco.setText(c.getEndereco());
			txb_cidade.setText(c.getCidade());
			txb_bairro.setText(c.getBairro());
			txb_estado.setText(c.getEstado());
			txb_prifissao.setText(c.getProfissao());
			txb_email.setText(c.getEmail());
			campoCPF.setText(c.getCpf());
			campoData.setText(c.getNascimento());
			campoTelefone.setText(c.getTelefone());
			campoCelular.setText(c.getCelular());
			cb_estCivil.setSelectedItem(c.getEstCivil());
			cb_sexo.setSelectedItem(c.getSexo());
	...
	public void init_event(){
		...
		bt_Cancelar.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent event5) {
				editaPaciente.this.setVisible(false);
